...
"""Shim exposing Bazel's native `cc_proto_library` rule.

The BUILD files in this repository load `cc_proto_library` from this label because
...
Generates C++ bindings for the proto_library targets in deps.
"""
