...
"""Shim exposing Bazel's native `java_lite_proto_library` rule.

The BUILD files in this repository load `java_lite_proto_library` from this label because
...
Generates protobuf-lite Java bindings, the variant used on Android.
"""
