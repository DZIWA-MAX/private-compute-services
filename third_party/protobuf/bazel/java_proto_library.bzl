...
"""Shim exposing Bazel's native `java_proto_library` rule.

The BUILD files in this repository load `java_proto_library` from this label because
...
Generates full-runtime Java bindings for the proto_library targets in deps.
"""
